...
describe('clearList / listToText', () => {
  ...
  it('listToText returns an empty string when the server omits the key', () => {
...
describe('default values', () => {
  ...
  it('\"Add Scope\" starts from empty but with \"Use This DNS Server\" checked', () => {
    expect(blankForm().useThisDnsServer).toBe(true)
  })
})

describe('formFromScope', () => {
