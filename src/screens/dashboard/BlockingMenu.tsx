...
const DURATIONS: { minutes: number; text: string }[] = [
  { minutes: 1, text: 'Disable Blocking For 1 Minute' },
  { minutes: 2, text: 'Disable Blocking For 2 Minutes' },
  { minutes: 5, text: 'Disable Blocking For 5 Minutes' },
  { minutes: 10, text: 'Disable Blocking For 10 Minutes' },
  { minutes: 15, text: 'Disable Blocking For 15 Minutes' },
  { minutes: 30, text: 'Disable Blocking For 30 Minutes' },
  { minutes: 60, text: 'Disable Blocking For 1 Hour' },
  { minutes: 180, text: 'Disable Blocking For 3 Hours' },
]
