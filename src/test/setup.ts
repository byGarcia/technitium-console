...
It is a stub and not a simulation: it records nothing and never fires. A test that
needs the callback to fire installs its own with `vi.stubGlobal`, which is what
`ui/SectionIndex.test.tsx` already does. Making this one fire would put fake
scroll behaviour under every test in the suite.
*/
